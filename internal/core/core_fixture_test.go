...
func (e *testEnvironment) Execute(ctx context.Context, input ExecuteInput) (ExecutionSnapshot, error) {
	operation, cancel := e.operation(ctx)
	defer cancel()
...
func (e *testEnvironment) CancelExecution(id ExecutionID) (ExecutionSnapshot, error) {
...
func (e *testEnvironment) OpenDebugSession(ctx context.Context, input OpenDebugInput) (DebugSnapshot, error) {
	operation, cancel := e.operation(ctx)
	defer cancel()
...
func (e *testEnvironment) StartDebug(ctx context.Context, id DebugSessionID) (DebugSnapshot, error) {
...
func (e *testEnvironment) ContinueDebug(ctx context.Context, id DebugSessionID) (DebugSnapshot, error) {
	operation, cancel, session, err := e.debugSession(ctx, id)
	if err != nil {
		return DebugSnapshot{}, err
	}
...
func (e *testEnvironment) StopDebug(ctx context.Context, id DebugSessionID) (DebugSnapshot, error) {
	operation, cancel, session, err := e.debugSession(ctx, id)
	if err != nil {
		return DebugSnapshot{}, err
	}
...
func (e *testEnvironment) Close(ctx context.Context) error {
	...
	if hasCategory(err, ErrorConnectionNotFound) && e.close.Started() {
